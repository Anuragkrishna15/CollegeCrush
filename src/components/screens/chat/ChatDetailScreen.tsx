        ...
        <AnimatePresence>
            ...
            {showRizzMeter && (
                <MotionDiv
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: 20 }}
                    className="absolute bottom-28 inset-x-4 md:inset-x-auto md:bottom-24 md:right-4 z-20 w-full max-w-sm mx-auto md:w-96 md:mx-0"
                >
                    <div className="relative">
                        <button 
                            onClick={() => setShowRizzMeter(false)} 
                            className="absolute -top-2 -right-2 z-10 bg-zinc-800 rounded-full p-1 text-zinc-400 hover:text-white shadow-lg"
                        >
                            <X size={20}/>
                        </button>
